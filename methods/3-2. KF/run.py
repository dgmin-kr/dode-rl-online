...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="KF online baseline over the shared test split.")
...
def run_one_trial(
    ...
    *,
    ...
    if not test_scenarios:
        raise ValueError("Test split is empty. Generate a scenario dataset before running KF.")
