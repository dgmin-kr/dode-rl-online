...
_DEFAULT_NETWORK_NAME = canonical_network_name(get_network_name("w_spsa"))
...
def _resolve_settings(network_name: str) -> tuple[str, dict[str, Any], dict[str, Any], dict[str, Any]]:
    ...
    return (
        ...
        get_experiment_settings("w_spsa", canonical_name),
...
class Config:
    ...
    W_SPSA_PARAMS: dict[str, Any] = dict(_EXPERIMENT_SETTINGS["w_spsa_params"])
    ...
    def configure_network(cls, network_name: str) -> None:
        ...
        cls.W_SPSA_PARAMS = dict(utils["w_spsa_params"])
